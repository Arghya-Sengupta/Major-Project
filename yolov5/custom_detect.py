# change the directories (in line 8, 226, 304) accordingly
        ...
        for i, det in enumerate(pred):  # per image
            ...
            if save_img:
                if dataset.mode == 'image':
                    ...
                    results_path = directory + "Results/" + file_name
                    # cv2.imwrite(results_path, im0)

                    img = Image.open(save_path)
                    I1 = ImageDraw.Draw(img)
                    myFont = ImageFont.truetype(r'D:/Major-Project/yolov5/arial.ttf',25)
                    # Add Text to an image
                    total_calories = "Total="+ str(total_calories) + "kcal"
                    I1.text((0, 0), total_calories, font=myFont, fill ="black")
                    if(save_result):
                        img.save("D:/Major-Project/Results/result.jpg") # results_path
...
f = open("D:/Major-Project/result.txt", "w")
